...
@ccclass
export default class shopItem1 extends cc.Component {
    ...
    onLoad(){
        ...
        cc.game.on(NameTs.Game_Shop_TurretItem,(res)=>{
    ...
    click(){
        ...
        cc.game.emit(NameTs.Game_Shop_TurretItem,this.initData.level);
    }
